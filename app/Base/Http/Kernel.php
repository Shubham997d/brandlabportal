...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Base\Http\Middleware\LastUserActivity::class
    ];
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Base\Http\Middleware\LogoutUsers::class,
    ...
    protected $routeMiddleware = [
        ...
        'CheckUserPermission'     => \App\Base\Http\Middleware\CheckUserPermission::class,
