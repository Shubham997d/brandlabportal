...
class UserRegisteredUpdateAdmin extends Notification implements ShouldQueue, ShouldBroadcast
{
    use Queueable;
   ...
   {  
        return (new MailMessage())
                        ...
                        ->markdown('emails.user-registered-update-admin',['user' => $this->extraData['user']]);                        
    }
    ...
    {   
        return [
            ...
            'object_type' => 'user',
            'object_name' => 'UserRegisteredUpdateAdmin',
