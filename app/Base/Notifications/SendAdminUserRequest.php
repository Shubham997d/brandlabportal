...
class SendAdminUserRequest extends Notification implements ShouldQueue, ShouldBroadcast
{
    use Queueable;
   ...
   {  
        ...
        return (new MailMessage())
                        ...
                        ->markdown('emails.send-admin-user-request',['mailData' => $this->dynamic['mailData']]);                        
    }
    ...
    {   
        return [
            ...
            'object_type' => 'user',
            'object_name' => 'SendAdminUserRequest',
