...
class Task extends Model
{
     ...
     */
    protected $fillable = [
        'name', 'assigned_to', 'created_by', 'notes', 'due_on', 'taskable_type', 'taskable_id', 'status_id', 'related_to', 'parent_id', 'cycle_id','task_duration',
    ];

    protected $casts = [
        'assigned_to' => 'integer', 'task_duration' => 'array',
    ];
