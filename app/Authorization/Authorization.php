...
class Authorization
{
    ...
    public function userHasPermissionTo($action, $resource, $resourceId = null, $groupRelated = false, $groupType = null, $groupId = null, $related = [] , $dealsRelated = [] )
    {      
        if(auth()->user()->isAdmin() === true) { // As advised by client admin can add/edit anything
            return true;
        }
