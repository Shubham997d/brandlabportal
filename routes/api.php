...
Route::group(['prefix' => 'api'], function () { // without auth
    // Stripe Webhooks
    
    // Route::get('stripe/webhook/checkout/session/completed', [StripeWebhookController::class, 'checkoutSessionCompleted']);
    Route::any('stripe/webhook/access', [StripeWebhookController::class, 'accessWebhook']);
